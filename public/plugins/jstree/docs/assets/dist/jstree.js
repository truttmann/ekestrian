 ...
 */
	...
	$.jstree.defaults.core = {
		...
		strings			: false,
		/**
		 * determines what happens when a acl tries to modify the structure of the tree
		...
		/**
		 * if left as `true` all parents of all selected nodes will be opened once the tree loads (so that all selected nodes are visible to the acl)
	...
	$.jstree.core.prototype = {
		...
		/**
		 * called when a node is selected by the acl. Used internally.
		 * @private
		...
		activate_node : function (obj, e) {
			...
			/**
			 * triggered when an node is clicked or intercated with by the acl
			 * @event
		...
		/**
		 * applies the hover state on a node, called when a node is hovered by the acl. Used internally.
		 * @private
		 * @name hover_node(obj)
		 * @param {mixed} obj
		...
		/**
		 * removes the hover state from a nodecalled when a node is no longer hovered by the acl. Used internally.
		 * @private
 ...
 * ### State plugin
 *
 * Saves the state of the tree (selected nodes, opened nodes) on the acl's computer using available options (localStorage, cookies, etc)
 */
	...
	$.jstree.plugins.state = function (options, parent) {
		...
		/**
		 * restore the state from the acl's computer
		 * @name restore_state()
		 * @plugin state
		 */
		...
		/**
		 * clear the state on the acl's computer
		 * @name clear_state()
		 * @plugin state
		 */
