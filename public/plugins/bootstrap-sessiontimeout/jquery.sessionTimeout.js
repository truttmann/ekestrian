...
//
// After a set amount of time, a dialog is shown to the acl with the option
...
//
//   message
//     Text shown to acl in dialog after warning period.
...
//
//   logoutUrl
//     URL to take browser to if acl clicks "Log Out Now"
//     Default: '/log-out'
//
//   warnAfter
...
(function( $ ){
	jQuery.sessionTimeout = function( options ) {
		...
		// Extend acl-set options over defaults
		var o = defaults,
				dialogTimer,
				redirTimer;
