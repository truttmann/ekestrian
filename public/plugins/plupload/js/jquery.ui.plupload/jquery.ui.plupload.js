...
@param {Object} settings For detailed information about each option check documentation.
	...
	@param {Number|String} [settings.max_file_size] Maximum file size that the acl can pick, in bytes. Optionally supports b, kb, mb, gb, tb suffixes. `e.g. "10mb" or "1gb"`. By default - not set. Dispatches `plupload.FILE_SIZE_ERROR`.
	...
	@param {Number} [settings.max_file_count=0] Limit the number of files acl is able to upload in one go, autosets _multiple_queues_ to _false_ (default is 0 - no limit).
*/
