...
(function ($) {
    ...
    EditableForm.prototype = {
        ...
        **/        
        ...
        cancel: function() {   
            /**        
            Fired when form was cancelled by acl
            @event cancel 
            @param {Object} event event object
            **/              
        ...
        save: function(submitValue) {
            ...
            */
            ...
            if (send) { //send to server
                ...
                if(typeof this.options.url === 'function') { //acl's function
    ...
    */
    ...
    $.fn.editableform.defaults = {
        ...
        **/         
        ...
        If it returns **object like** <code>{newValue: &lt;something&gt;}</code> - it overwrites value, submitted by acl.
    ...
    **/  
    ...
    $.fn.editableContainer.defaults = {
        ...
        **/        
        autohide: true,
        /**
        Action when acl clicks outside the container. Can be <code>cancel|submit|ignore</code>.
        ...
        initLive: function() {
           ...
           this.$element.on(this.options.toggle + '.editable', selector, $.proxy(function(e){
               ...
               if(!$target.data('editable')) {
                   //if delegated element initially empty, we need to clear it's text (that was manually set to `empty` by acl)
    ...
    $.extend(Constructor.prototype, {
       ...
       value2input: function(value) {
           ...
           */
           ...
           this.$input.val(value).trigger('change', true); //second argument needed to separate initial change from acl's click (for autosubmit)
           
           //if remote source AND no acl's initSelection provided --> try to use element's text
...
(function ($) {
    ...
    $.extend(Constructor.prototype, {
        ...
        /*
         ...
         acl must pick some value from list, otherwise `null` returned.
