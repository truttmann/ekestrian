...
class NewsletterTable
{
    ...
    */
    public function getNewsletter($id){
        $id  = (int) $id;
        $rowset = $this->tableGateway->select(array('newsletter_id' => $id));
        $row = $rowset->current();
        if (!$row) {
    ...
    */
    public function save(Newsletter $newsletter)
    {
        ...
        $id = (int)$newsletter->newsletter_id;
        if ($id == 0) {
            $this->tableGateway->insert($data);
            $newsletter->newsletter_id = $this->tableGateway->getLastInsertValue();
        } else {
            if ($this->getNewsletter($id)) {
                $this->tableGateway->update($data, array('newsletter_id' => $id));
            } else {
    ...
    public function delete(Newsletter $newsletter) {
        ...
        $this->tableGateway->delete(array('newsletter_id' => $newsletter->newsletter_id));
        return ;
    }
